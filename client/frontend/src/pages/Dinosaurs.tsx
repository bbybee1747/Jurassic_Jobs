...
function Dinosaurs() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-10 font-sans">
      <div className="w-full max-w-4xl bg-white shadow-md rounded-lg p-8 border border-gray-200">
        ...
        <div className="mb-6 text-center">
          <label htmlFor="sort" className="text-lg font-semibold mr-2">
            Sort by:
          </label>
          <select
            id="sort"
